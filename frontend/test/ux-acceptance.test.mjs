...
test("UX acceptance: everyday launch information is understandable without technical settings", () => {
  ...
  const html = renderToStaticMarkup(createElement(SelectorLayout, {
    projectIdentity: createElement(ProjectIdentity, {project}),
    contextCards: createElement(ContextCard, {context, selected: true, onSelect() {}}),
    confidenceSummary: createElement(SelectorConfidenceSummary, {project, context}),
    rememberControl: createElement("p", null, "Company is the remembered context for this project."),
