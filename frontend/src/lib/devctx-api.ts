...
export interface DeleteContextPreviewRequest {
	contextId: string;
}
...
export interface DeleteContextPreview {
	context: ContextState;
	projectBindings: ProjectState[];
	deletesIsolatedState: boolean;
}
export interface DeleteContextResult {
	contextId: string;
	removedProjectBindings: ProjectState[];
}
...
export interface TrustContextProtection {
	id: string;
	name: string;
	providers: TrustProviderProtection[];
	tool: TrustCodingToolProtection;
}
export interface TrustProviderProtection {
	id: string;
	name: string;
	isolation: TrustIsolationProtection;
}
export interface TrustCodingToolProtection {
	id: string;
	name: string;
	isolation: TrustIsolationProtection;
}
export interface TrustIsolationProtection {
	status: LaunchConfidenceStatus;
	message: string;
}
export interface TrustProjectMapping {
	project: ProjectState;
	contextId: string;
	contextName: string;
}
export interface TrustCredentialSyncProtection {
	enabled: boolean;
	message: string;
}
export interface TrustIntegrationBoundary {
	toolId: string;
	toolName: string;
...
export interface HomeRunningContextCount {
	contextId: string;
	contextName: string;
	count: number;
}
...
export type LaunchConfidenceCheckComponent =
	| "provider"
	| "tool"
	| "isolation"
	| "identity";
...
export interface ContextTemplateState {
	id: string;
	name: string;
	description: string;
	icon?: string;
...
export interface DuplicateContextResult {
	context: ContextState;
}
...
export interface ContextTransferMetadata {
	name: string;
	metadata?: Record<string, string>;
	providers: ContextTransferProvider[];
	launchTarget: ContextTransferLaunchTarget;
}
export interface ContextTransferProvider {
	id: string;
	enabled: boolean;
	options?: Record<string, string>;
}
export interface ContextTransferLaunchTarget {
	defaultTool: string;
	tools: ContextTransferTool[];
}
export interface ContextTransferTool {
	id: string;
	options?: Record<string, string>;
}
...
export interface GetRepairActionsRequest {
	contextId: string;
}
export interface RepairActionsState {
...
export interface RunRepairActionRequest {
	contextId: string;
	actionId: string;
	confirmDestructive?: boolean;
}
export interface RunRepairActionResult {
	actionId: string;
...
export interface RunningEnvironmentsState {
...
export interface RunningEnvironmentProcessState {
	state: string;
	pid?: number;
}
export interface RunningEnvironmentSessionState {
	id?: string;
	state: string;
}
export interface RunningEnvironmentLaunchState {
	source: string;
	resolutionSource: string;
}
...
export interface DevContextApi {
	...
	getHomeDashboard(
		request?: GetHomeDashboardRequest,
	): Promise<ApiResult<HomeDashboardState>>;
	...
	updateContextDevelopmentTools(
		request: UpdateContextDevelopmentToolsRequest,
	): Promise<ApiResult<ContextState>>;
	archiveContext(
		request: ArchiveContextRequest,
	): Promise<ApiResult<ContextState>>;
	restoreContext(
		request: RestoreContextRequest,
	): Promise<ApiResult<ContextState>>;
	previewDeleteContext(
		request: DeleteContextPreviewRequest,
	): Promise<ApiResult<DeleteContextPreview>>;
	deleteContext(
		request: DeleteContextRequest,
	): Promise<ApiResult<DeleteContextResult>>;
	...
	): Promise<ApiResult<DiagnosticsState>>;
	getRepairActions(
		request: GetRepairActionsRequest,
	): Promise<ApiResult<RepairActionsState>>;
	runRepairAction(
		request: RunRepairActionRequest,
...
export function createDevContextApi(
	...
	return {
		...
		getHomeDashboard(request = {}) {
			return callBinding(
				() => bindings.getHomeDashboard(request),
				normalizeHomeDashboardState,
			);
		},
		getRecentProjects() {
			return callBinding(
				() => bindings.getRecentProjects(),
				normalizeRecentProjectsState,
			);
		},
		getContexts() {
			return callBinding(
				() => bindings.getContexts(),
				normalizeContextListState,
			);
		},
		...
		updateContextDevelopmentTools(request) {
			return callBinding(
				() => bindings.updateContextDevelopmentTools(request),
				normalizeContextState,
			);
		},
		archiveContext(request) {
			return callBinding(
				() => bindings.archiveContext(request),
				normalizeContextState,
			);
		},
		restoreContext(request) {
			return callBinding(
				() => bindings.restoreContext(request),
				normalizeContextState,
			);
		},
		previewDeleteContext(request) {
			return callBinding(
				() => bindings.previewDeleteContext(request),
				normalizeDeleteContextPreview,
			);
		},
		deleteContext(request) {
			return callBinding(
				() =>
					bindings.deleteContext({
						...request,
						confirmDelete: request.confirmDelete ?? false,
					}),
				normalizeDeleteContextResult,
			);
		},
		getTrustCenter() {
			return callBinding(
				() => bindings.getTrustCenter(),
				normalizeTrustCenterState,
			);
		},
		...
		createContext(request) {
			return callBinding(
				() => bindings.createContext(request),
				normalizeCreateContextResult,
			);
		},
		getContextTemplates() {
			return callBinding(
				() => bindings.getContextTemplates(),
				normalizeContextTemplatesState,
			);
		},
		duplicateContext(request) {
			return callBinding(
				() => bindings.duplicateContext(request),
				normalizeDuplicateContextResult,
			);
		},
		exportContextMetadata(request) {
			return callBinding(
				() => bindings.exportContextMetadata(request),
				normalizeContextMetadataExport,
			);
		},
		importContextMetadata(request) {
			return callBinding(
				() => bindings.importContextMetadata(request),
				normalizeImportContextMetadataResult,
			);
		},
		getProjects() {
			return callBinding(() => bindings.getProjects(), normalizeProjectsState);
		},
		getDiagnostics(request = {}) {
			return callBinding(
				() => bindings.getDiagnostics(request),
				normalizeDiagnosticsState,
			);
		},
		getRepairActions(request) {
			return callBinding(
				() => bindings.getRepairActions(request),
				normalizeRepairActionsState,
			);
		},
		runRepairAction(request) {
			return callBinding(
				() =>
					bindings.runRepairAction({
						...request,
						confirmDestructive: request.confirmDestructive ?? false,
					}),
				normalizeRunRepairActionResult,
			);
		},
		getHistory() {
			return callBinding(() => bindings.getHistory(), normalizeHistoryState);
		},
		getRunningEnvironments() {
			return callBinding(
				() => bindings.getRunningEnvironments(),
		...
		updateSettings(request) {
			return callBinding(
				() => bindings.updateSettings(request),
...
const generatedBindings: WailsBindings = {
	...
	async updateContextDevelopmentTools(request) {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
		return bindings.UpdateContextDevelopmentTools(request);
	},
	async archiveContext(request) {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
		return bindings.ArchiveContext(request);
	},
	async restoreContext(request) {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
		return bindings.RestoreContext(request);
	},
	async previewDeleteContext(request) {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
		return bindings.PreviewDeleteContext(request);
	},
	async deleteContext(request) {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
		return bindings.DeleteContext({
			...request,
			confirmDelete: request.confirmDelete ?? false,
		});
	},
	...
	async getContextTemplates() {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
		return bindings.GetContextTemplates();
	},
	async duplicateContext(request) {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
	...
	async importContextMetadata(request) {
		...
		return bindings.ImportContextMetadata(
			models.application.ImportContextMetadataRequest.createFrom(request),
		);
	},
	async getProjects() {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
		return bindings.GetProjects();
	},
	async getDiagnostics(request) {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
		return bindings.GetDiagnostics(request);
	},
	async getRepairActions(request) {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
		return bindings.GetRepairActions(request);
	},
	async runRepairAction(request) {
		const bindings = await import("../../wailsjs/go/wailsapp/App");
		return bindings.RunRepairAction({
			...request,
			confirmDestructive: request.confirmDestructive ?? false,
		});
	},
...
function normalizeSettingsState(value: unknown): SettingsState {
	...
	return {
		closeAfterLaunch: booleanValue(object.closeAfterLaunch),
...
function normalizeLaunchState(value: unknown): LaunchState {
	...
	return {
		...
		providerCredentialSessions: arrayValue(
...
function normalizeHomeDashboardState(value: unknown): HomeDashboardState {
	const object = objectValue(value);
	const currentContext = normalizeHomeCurrentContextState(
		object.currentContext,
	);
	return {
		project: normalizeProjectState(object.project),
		...(currentContext === undefined ? {} : { currentContext }),
		recentProjects: arrayValue(object.recentProjects).map(
			normalizeRecentProjectState,
		),
...
function normalizeHomeCurrentContextState(
	value: unknown,
): HomeCurrentContextState | undefined {
...
function normalizeRecentProjectsState(value: unknown): RecentProjectsState {
	return {
		projects: arrayValue(objectValue(value).projects).map(
			normalizeRecentProjectState,
		),
	};
}
...
function normalizeContextListState(value: unknown): ContextListState {
	return {
		contexts: arrayValue(objectValue(value).contexts).map(
			normalizeContextListItem,
		),
	};
}
...
function normalizeContextListItem(value: unknown): ContextListItem {
	...
	return {
		...
		enabledProviders: arrayValue(object.enabledProviders).map(
...
function normalizeTrustCenterState(value: unknown): TrustCenterState {
	...
	return {
		...
		projectMappings: arrayValue(object.projectMappings).map(
			normalizeTrustProjectMapping,
		),
		credentialSync: normalizeTrustCredentialSyncProtection(
			object.credentialSync,
		),
		integrationBoundaries: arrayValue(object.integrationBoundaries).map(
			normalizeTrustIntegrationBoundary,
		),
	};
}
function normalizeTrustContextProtection(
	value: unknown,
): TrustContextProtection {
	const object = objectValue(value);
	return {
		id: stringValue(object.id),
		name: stringValue(object.name),
		providers: arrayValue(object.providers).map(
			normalizeTrustProviderProtection,
		),
		tool: normalizeTrustCodingToolProtection(object.tool),
	};
}
function normalizeTrustProviderProtection(
	value: unknown,
): TrustProviderProtection {
	const object = objectValue(value);
	return {
		id: stringValue(object.id),
		name: stringValue(object.name),
		isolation: normalizeTrustIsolationProtection(object.isolation),
	};
}
function normalizeTrustCodingToolProtection(
	value: unknown,
): TrustCodingToolProtection {
	const object = objectValue(value);
	return {
		id: stringValue(object.id),
		name: stringValue(object.name),
...
function normalizeTrustIsolationProtection(
	value: unknown,
): TrustIsolationProtection {
	const object = objectValue(value);
	return {
...
function normalizeTrustProjectMapping(value: unknown): TrustProjectMapping {
	const object = objectValue(value);
	return {
		project: normalizeProjectState(object.project),
		contextId: stringValue(object.contextId),
		contextName: stringValue(object.contextName),
	};
}
function normalizeTrustCredentialSyncProtection(
	value: unknown,
): TrustCredentialSyncProtection {
	const object = objectValue(value);
	return {
...
function normalizeTrustIntegrationBoundary(
	value: unknown,
): TrustIntegrationBoundary {
	const object = objectValue(value);
	return {
		toolId: stringValue(object.toolId),
		toolName: stringValue(object.toolName),
		statusDataAvailable: booleanValue(object.statusDataAvailable),
		message: stringValue(object.message),
	};
}
...
function normalizeHomeRunningSummary(value: unknown): HomeRunningSummary {
	...
	return {
		...
		contextCounts: arrayValue(object.contextCounts).map(
			normalizeHomeRunningContextCount,
		),
		isolationProtected: booleanValue(object.isolationProtected),
	};
}
function normalizeHomeRunningContextCount(
	value: unknown,
): HomeRunningContextCount {
	const object = objectValue(value);
	return {
		contextId: stringValue(object.contextId),
		contextName: stringValue(object.contextName),
...
function normalizeLaunchConfidenceState(
	value: unknown,
): LaunchConfidenceState | undefined {
	if (value === undefined || value === null) {
		return undefined;
	}
...
function normalizeLaunchConfidenceStatus(
	value: unknown,
): LaunchConfidenceStatus {
	switch (value) {
		case "ready":
...
function normalizeLaunchConfidenceCheckComponent(
	value: unknown,
): LaunchConfidenceCheckComponent {
	switch (value) {
		case "provider":
		case "tool":
		case "isolation":
...
function normalizePreflightLaunchProjectResult(
	value: unknown,
	...
	const runningEnvironmentConflict = optionalRunningEnvironmentConflict(
		object.runningEnvironmentConflict,
	);
	return {
		project: normalizeProjectState(object.project),
		context: normalizeContextState(object.context),
...
function optionalRunningEnvironmentConflict(
	value: unknown,
): RunningEnvironmentConflict | undefined {
	if (value === undefined || value === null) {
		return undefined;
	...
	const object = objectValue(value);
	const kind =
		object.kind === "same_context" || object.kind === "different_context"
			? object.kind
			: undefined;
	if (kind === undefined) {
		throw new Error("Invalid Dev Context response.");
	...
	return {
		kind,
		environment: normalizeRunningEnvironmentState(object.environment),
	};
}

function normalizeLaunchVerificationStep(
	value: unknown,
...
function normalizeLaunchVerificationStepStatus(
	value: unknown,
...
function normalizeContextTemplatesState(value: unknown): ContextTemplatesState {
	const object = objectValue(value);
	return {
...
function normalizeContextTemplateState(value: unknown): ContextTemplateState {
	...
	return {
		...
		accent: stringValue(object.accent),
	};
}
function normalizeDuplicateContextResult(
	value: unknown,
): DuplicateContextResult {
	const object = objectValue(value);
	return { context: normalizeContextState(object.context) };
}
function normalizeContextMetadataExport(value: unknown): ContextMetadataExport {
	const object = objectValue(value);
	return {
		version: numberValue(object.version),
		context: normalizeContextTransferMetadata(object.context),
	};
}
function normalizeContextTransferMetadata(
	value: unknown,
): ContextTransferMetadata {
	const object = objectValue(value);
	const metadata = optionalStringRecord(object.metadata);
	return {
		name: stringValue(object.name),
		...(metadata === undefined ? {} : { metadata }),
		providers: arrayValue(object.providers).map(
			normalizeContextTransferProvider,
		),
		launchTarget: normalizeContextTransferLaunchTarget(object.launchTarget),
	};
}
function normalizeContextTransferProvider(
	value: unknown,
): ContextTransferProvider {
	const object = objectValue(value);
	const options = optionalStringRecord(object.options);
	return {
		id: stringValue(object.id),
		enabled: booleanValue(object.enabled),
...
function normalizeContextTransferLaunchTarget(
	value: unknown,
): ContextTransferLaunchTarget {
	const object = objectValue(value);
	return {
		defaultTool: stringValue(object.defaultTool),
		tools: arrayValue(object.tools).map(normalizeContextTransferTool),
	};
}
function normalizeContextTransferTool(value: unknown): ContextTransferTool {
	const object = objectValue(value);
	const options = optionalStringRecord(object.options);
	return {
		id: stringValue(object.id),
...
function normalizeImportContextMetadataResult(
	value: unknown,
): ImportContextMetadataResult {
	return { context: normalizeContextState(objectValue(value).context) };
}
function normalizeProjectsState(value: unknown): ProjectsState {
	return {
		projects: arrayValue(objectValue(value).projects).map(
...
function normalizeProjectListItem(value: unknown): ProjectListItem {
	const object = objectValue(value);
	const contextId = optionalString(object.contextId);
	const contextName = optionalString(object.contextName);
	const lastLaunchedAt = optionalTimestamp(object.lastLaunchedAt);
	return {
		project: normalizeProjectState(object.project),
		...(contextId === undefined ? {} : { contextId }),
		...(contextName === undefined ? {} : { contextName }),
		...(lastLaunchedAt === undefined ? {} : { lastLaunchedAt }),
		running: booleanValue(object.running),
	};
}
function normalizeDiagnosticsState(value: unknown): DiagnosticsState {
	return {
		groups: arrayValue(objectValue(value).groups).map(normalizeDiagnosticGroup),
	};
}
function normalizeDiagnosticGroup(value: unknown): DiagnosticGroup {
	const object = objectValue(value);
	return {
		id: stringValue(object.id),
		label: stringValue(object.label),
		checks: arrayValue(object.checks).map(normalizeDiagnosticCheck),
	};
}
...
function normalizeDiagnosticDetail(value: unknown): DiagnosticDetail {
	...
	return {
		...
		isPath: booleanValue(object.isPath),
	};
}
function normalizeRepairActionsState(value: unknown): RepairActionsState {
	return {
		actions: arrayValue(objectValue(value).actions).map(normalizeRepairAction),
	};
}
function normalizeRepairAction(value: unknown): RepairAction {
	const object = objectValue(value);
	return {
		id: stringValue(object.id),
		label: stringValue(object.label),
		description: stringValue(object.description),
		destructive: booleanValue(object.destructive),
		requiresConfirmation: booleanValue(object.requiresConfirmation),
		targets: arrayValue(object.targets).map(normalizeRepairTarget),
	};
}
function normalizeRepairTarget(value: unknown): RepairTarget {
	const object = objectValue(value);
	return {
		label: stringValue(object.label),
...
function normalizeRunRepairActionResult(value: unknown): RunRepairActionResult {
	const object = objectValue(value);
	return {
		actionId: stringValue(object.actionId),
		diagnostics: normalizeDiagnosticsState(object.diagnostics),
	};
}
function normalizeHistoryState(value: unknown): HistoryState {
	return {
		entries: arrayValue(objectValue(value).entries).map(normalizeHistoryEntry),
	};
}
function normalizeHistoryEntry(value: unknown): HistoryEntry {
	...
	return {
		...
		toolId: optionalString(object.toolId),
		message: stringValue(object.message),
	};
}
function normalizeRunningEnvironmentsState(
	value: unknown,
): RunningEnvironmentsState {
	return {
		environments: arrayValue(objectValue(value).environments).map(
...
function normalizeRunningEnvironmentState(
	...
	return {
		id: stringValue(object.id),
		project: normalizeProjectState(object.project),
		context: normalizeRunningEnvironmentContextState(object.context),
		tool: normalizeToolOption(object.tool),
		startedAt: stringValue(object.startedAt),
...
function normalizeRunningEnvironmentContextState(
	value: unknown,
): RunningEnvironmentContextState {
	const object = objectValue(value);
	return { id: stringValue(object.id), name: stringValue(object.name) };
}
function normalizeRunningEnvironmentProcessState(
	value: unknown,
): RunningEnvironmentProcessState {
	const object = objectValue(value);
...
function normalizeRunningEnvironmentSessionState(
	value: unknown,
): RunningEnvironmentSessionState {
	const object = objectValue(value);
...
function normalizeRunningEnvironmentLaunchState(
	value: unknown,
): RunningEnvironmentLaunchState {
	const object = objectValue(value);
	return {
		source: stringValue(object.source),
		resolutionSource: stringValue(object.resolutionSource),
	};
}
...
function normalizeContextState(value: unknown): ContextState {
	...
	return {
		...
		...(optionalString(object.archivedAt) === undefined
			? {}
			: { archivedAt: optionalString(object.archivedAt) }),
	};
}
...
function normalizeDeleteContextPreview(value: unknown): DeleteContextPreview {
	...
	return {
		context: normalizeContextState(object.context),
		projectBindings: arrayValue(object.projectBindings).map(
			normalizeProjectState,
		),
		deletesIsolatedState: booleanValue(object.deletesIsolatedState),
	};
}
...
function normalizeDeleteContextResult(value: unknown): DeleteContextResult {
	...
	return {
		contextId: stringValue(object.contextId),
		removedProjectBindings: arrayValue(object.removedProjectBindings).map(
			normalizeProjectState,
		),
	};
}
...
function normalizeProviderSetupAction(
	value: unknown,
): ProviderSetupAction | undefined {
	if (value === undefined || value === null) {
		return undefined;
	}
...
function normalizeProviderReadinessState(
	value: unknown,
...
function normalizeProviderIdentityStatus(
	value: unknown,
...
function normalizeProviderCredentialSession(
	value: unknown,
