...
/** A focused, dismissible side sheet. Base UI restores focus to its trigger on close. */
...
function SheetDescription({
	...
	return (
		<SheetPrimitive.Description
			...
			className={cn("text-body text-secondary mt-0.5", className)}
			{...props}
		/>
	);
}
