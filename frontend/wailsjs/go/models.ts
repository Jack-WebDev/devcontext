export namespace application {
	...
	export class ContextMetadataExportOptions {
	    includeMetadata: boolean;
	    includeProviderOptions: boolean;
	    includeToolOptions: boolean;
	
	    static createFrom(source: any = {}) {
	        return new ContextMetadataExportOptions(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.includeMetadata = source["includeMetadata"];
	        this.includeProviderOptions = source["includeProviderOptions"];
	        this.includeToolOptions = source["includeToolOptions"];
	    }
	}
	...
	export class ExportContextMetadataRequest {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.contextId = source["contextId"];
	        this.options = this.convertValues(source["options"], ContextMetadataExportOptions);
	    }
