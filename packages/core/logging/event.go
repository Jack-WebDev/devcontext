...
const (
	...
	EventProviderAuthenticated   EventName = "provider_authenticated"
	EventProviderReset           EventName = "provider_reset"
	EventRepairCompleted         EventName = "repair_completed"
	EventProjectBound            EventName = "project_bound"
	EventProjectUnbound          EventName = "project_unbound"
	EventContextOverrideAccepted EventName = "context_override_accepted"
	EventWorkspaceStopped        EventName = "workspace_stopped"
)
